...
function perfectScroller(element) {
  if ($(element).length > 0) {
...
function drawSparkline(element, data, options) {
  element.sparkline(data, options);
}

function drawFlotChart(element, data) {
  $.plot(element, [data.purchasesChart, data.plansChart, data.servicesChart], {
    series: {
      lines: {
...
$(document).ready(function() {
  perfectScroller(".js-scroller-notifications");
  perfectScroller(".js-scroller-chat-contact");
  perfectScroller(".js-scroller-todo");
  perfectScroller(".js-scroller-setting");
  perfectScroller(".js-scroll-left-sidebar");

  $(".js-toggle-setting").on("click", function(event) {
    event.preventDefault();
    $(".right-sidebar").toggleClass("open");
  });

  // left-sidebar: collapse all submenu inner
  $(".js-collapse-submenu").on("hidden.bs.collapse", function() {
    $(this)
      .find(".collapse")
      .collapse("hide");
  });
  ...
  $(".js-sparkline").each(function() {
    var _ele = $(this);
    var _dataset = $(this).data("set");

    drawSparkline(_ele, _dataset.data, _dataset.option);
  });

  $(".js-movement-chart").each(function() {
    var _ele = $(this);
    var _dataset = $(this).data("set");

    drawFlotChart(_ele, _dataset);
  });

  $(".js-toggle-reload").on("click", function(){
    var _container = $(this).parents(".recent-movement");
    _container.length && (_container.addClass("reload"), setTimeout(function() {
      _container.removeClass("reload")
  }, 4000))
  });
});
